...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('products', function (Blueprint $table) {
            $table->foreignId('group_id')->nullable()->constrained('product_groups')->nullOnDelete()->after('supplier_id');
        ...
        Schema::table('stock_lots', function (Blueprint $table) {
            $table->foreignId('product_option_id')->nullable()->constrained('product_options')->nullOnDelete()->after('product_id');
